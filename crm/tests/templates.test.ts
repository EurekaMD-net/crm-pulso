...
describe("global.md -- tool coverage", () => {
  ...
  it("references all 33 tool names", () => {
    expect(allToolNames.size).toBe(33);
...
describe("manager.md -- tool references", () => {
  ...
  it("references all 23 gerente tools", () => {
...
describe("director.md -- tool references", () => {
  ...
  it("references all 22 director tools", () => {
